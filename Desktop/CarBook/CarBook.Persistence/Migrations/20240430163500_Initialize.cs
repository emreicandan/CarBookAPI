    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarPayments_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarPayments_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarPayments_CarId",
                table: "CarPayments",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarPayments_PaymentId",
                table: "CarPayments",
                column: "PaymentId");
